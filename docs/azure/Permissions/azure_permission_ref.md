...
| Microsoft.ContainerRegistry/registries/pull/read | Pull image | does not have authorization to perform action 'Microsoft.ContainerRegistry/registries/pull/read' | Microsoft.ContainerRegistry | Provisioner |
