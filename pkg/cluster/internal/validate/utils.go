...
func validateStruct(s interface{}) (err error) {
	...
	fmt.Println("(9)(1) Path: Skind/pkg/cluster/internal/validate/utils.go - Function: validateStruct()")        // Added by JANR
	fmt.Println("(9)(1) Brief function goal: Validates the input struct by checking if all its fields are set.") // Added by JANR
	...
	fmt.Println("(9)(1) - Print - structType: ", structType) // Added by JANR
	...
	for i := 0; i < fieldNum; i++ {
		...
		// Print information in different lines: // Added by JANR
		fmt.Println("(9)(2) - Print - field: ", field)         // Added by JANR
		fmt.Println("(9)(2) - Print - fieldName: ", fieldName) // Added by JANR

		isSet := field.IsValid() && !field.IsZero()
		// Print information in different lines: // Added by JANR
		fmt.Println("(9)(2) - Print - isSet: ", isSet) // Added by JANR
...
func convertToMapStringString(m map[string]interface{}) map[string]string { // This func converts a map[string]interface{} to a map[string]string. // Added by JANR
	...
	// Brief function goal: // Added by JANR
	// All functions called in order: // Added by JANR
	fmt.Println("(9)(3) Path: Skind/pkg/cluster/internal/validate/utils.go - Function: convertToMapStringString()") // Added by JANR
	fmt.Println("(9)(3) Brief function goal: Converts a map[string]interface{} to a map[string]string.")            // Added by JANR
	var m2 = map[string]string{}                                                                                    // This m2 is a map[string]string type, which means it is an empty map. // Added by JANR
	// Print information in different lines: // Added by JANR
	fmt.Println("(9)(3) - Print - m: ", m) // Added by JANR
	for k, v := range m {
		// Print information in different lines: // Added by JANR
		fmt.Println("(9)(3) - Print - k: ", k) // Added by JANR
